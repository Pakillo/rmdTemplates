...
```{r Fig-scatterplot, fig.cap="Just my first figure with a very fantastic caption.", cache=FALSE}
x <- rnorm(100)
y <- jitter(x, 1000)
plot(x, y)
```
...
```{r Fig-landscape, fig.cap="Second figure in landscape format.", cache=FALSE}
a <- sort(rnorm(100))
