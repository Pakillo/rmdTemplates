...
#   refs <- read.bibtex("references.bib", check=FALSE)
```



```{r analysis, include=FALSE, echo=FALSE, cache=FALSE}
# Optionally, all analysis in here, that way all bits of the paper have access to the final objects
...
After knitting Rmd document, modify TeX document directly to place reference list in the appropriate place.

```{r generate_references, cache=FALSE, include=FALSE}
