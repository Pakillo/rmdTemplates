...
csl: skeleton/ecology.csl
documentclass: skeleton/elsarticle

output: 
  pdf_document:
    template: skeleton/elsarticle.latex
    toc: false
    fig_caption: true
...
If you put a BibTeX file with references ("references.bib") in the "components" directory, you can cite any of them like these: @Xie_2013. Or cite by doi, e.g. `r citet("10.1098/rspb.2013.1372")`, thanks to `knitcitations` package `r citep(citation("knitcitations"))`. 
